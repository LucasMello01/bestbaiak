local config = {
money = 35000000, -- Dinheiro que vai custar
...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_DEFAULT, "Desculpe, você precisa de 35kk e você nao tem dinheiro suficiente.")
